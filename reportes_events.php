...
if( $VST_PI_REPORTESSearch->Validate() == 1)
{
	...
	{
		$resultado = "RUT;RUT BANCO;LICITACIÓ;CREDITO UF;MONTO A PAGAR;RUT IES;NOMBRE IES;FECHA PAGO;FECHA CARGA;TIPO PAGO;ESTADO \r\n";		    
	...
	{
		$resultado = "RUT;RUT BANCO;LICITACIÓN;OPERACIÓN;ARANCEL SOLICITADO;MONTO CRÍDITO;CREDITO UF;MONTO SEGURO IES;MONTO A PAGAR;MONTO OTRA CTA;PLAZO;TASA;FECHA CURSE;RUT IES;NOMBRE IES;FECHA PAGO;FECHA CARGA;TIPO PAGO;ESTADO \r\n";		    
