...
// -------------------------
	if(trim($PI_TRANSFERENCIAS->COMENTARIO_ELIMINADO->GetValue()) == '' )
		$PI_TRANSFERENCIAS->Errors->addError("El comentario es obligatorio.");
	if(strlen($PI_TRANSFERENCIAS->COMENTARIO_ELIMINADO->GetValue())> 200)
